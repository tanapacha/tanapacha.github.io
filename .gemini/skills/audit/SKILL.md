...
- **Suggested command**: Which command to use (prefer: /adapt, /colorize, /clarify, /delight, /onboard, /normalize, /distill, /audit, /extract, /polish, /optimize, /quieter, /bolder, /animate, /harden, /critique — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /adapt, /colorize, /clarify, /delight, /onboard, /normalize, /distill, /audit, /extract, /polish, /optimize, /quieter, /bolder, /animate, /harden, /critique. You may also suggest other installed skills you're sure exist, but never invent commands.
