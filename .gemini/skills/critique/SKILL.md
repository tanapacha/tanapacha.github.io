...
- **Command**: Which command to use (prefer: /adapt, /colorize, /clarify, /delight, /onboard, /normalize, /distill, /audit, /extract, /polish, /optimize, /quieter, /bolder, /animate, /harden, /critique — or other installed skills you're sure exist)
