...
function sendEmailNotification(recipients, subject, docTitle, docDescription, docID, senderName) {
  ...
  const appUrl = 'https://script.google.com/macros/s/AKfycbyO140nBtbPnfouP0F-mUjQ7WjRYkhqd4Ug-pLLcP3rBvCBx4puMp9SFy4bNIgMTd76/exec';
      ...
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); border: 1px solid #e2e8f0;">
        ...
        <div style="padding: 40px;">
          ...
          <div style="text-align: center;">
            <a href="${appUrl}" style="display: inline-block; background-color: ${primaryColor}; color: #ffffff; padding: 16px 32px; border-radius: 12px; font-size: 15px; font-weight: 700; text-decoration: none; box-shadow: 0 10px 15px -3px rgba(234, 88, 12, 0.3);">
              ตรวจสอบเอกสารและดำเนินต่อ
            </a>
            <p style="margin-top: 24px; font-size: 12px; color: #94a3b8;">หรือคัดลอกลิงก์นี้: <a href="${appUrl}" style="color: #64748b;">${appUrl}</a></p>
          </div>
        </div>
